(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".reasons-slider-right")) new core(".reasons-slider-right", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
        ...
        if (document.querySelector(".reasons-slider-left")) new core(".reasons-slider-left", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 32,
        ...
        if (videosWrap) {
            const videoEventHandler = e => {
                ...
                allVideos.forEach(((source, index) => {
                    ...
                    source.pause();
                    if (overlay) overlay[index].classList.remove("_active");
                }));
